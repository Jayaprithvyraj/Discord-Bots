    ...
    run: async function (client, message, args) {
        ...
        if (serverQueue) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Song has been added to queue", "https://user-images.githubusercontent.com/46924550/153585710-42002a8f-45fc-495d-8c29-07b62d08486b.gif?raw=true")
        ...
        const play = async (song) => {
            ...
            if (!song) {
                sendError(
                    "Thank you for using my bot, contact DFALT for more information :) ",
                    message.channel
                );
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://user-images.githubusercontent.com/46924550/153585710-42002a8f-45fc-495d-8c29-07b62d08486b.gif?raw=true")
                .setThumbnail(song.img)
                .setColor("#fffdd0")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
